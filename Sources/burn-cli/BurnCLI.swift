...
@main
struct BurnCLI: AsyncParsableCommand {
...
private func resolveAdminKey(flag: String?, provider: ProviderID) throws -> String {
    ...
    throw BurnError.message("\(providerName) Admin API key required for org billing (use --quota for personal subscription limits)")
}
